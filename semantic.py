...
#It is interesting that spacy can tell that cat and monkey are similar, as they are both animals.
#It is then also interesting that spacy can see a slight similarity between monkey and banana, as monkeys eat bananas.
#The program says that cat and apple are not similar, which is interesting 
